...
class DefaultController extends Controller
{
    ...
    public function defaultAction(Request $request, $sendResponse = true)
    {
        ...
        if (null === $page) {
            throw new HttpException(404, sprintf('The page `%s` can not be found.',  $request->getUri()));
        }
        ...
        if (null !== $page && false === $page->isOnline() && !$this->isGranted($role)) {
            throw new HttpException(404, sprintf('Please log in to edit the page.',  $request->getUri()));
        }
